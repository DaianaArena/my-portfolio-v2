    ...
    <div className="min-h-screen  animate-gradient-x flex flex-col justify-center items-center">
      ...
      {/* Left column with main text */}
        <div className="py-10 px-12  flex flex-col justify-center ">
          ...
          <p className="text-lg text-center lg:text-left md:text-sm lg:text-xl mb-8 text-gray-900">
          ...
          <div className="flex flex-col  sm:flex-row items-center justify-center md:items-center lg:justify-between ">
        ...
        <div className="py-10 px-12  flex flex-col justify-center order-first lg:order-last">
            <Image src={CVImage} alt=""  className='animate-float m-auto'/>
        </div>
